...
<%@page import="com.basics.Note"%>

<%@page import="org.hibernate.Session"%>
<%@page import="com.help.FactProvider"%>
...
<html lang="en">
  ...
  <body>
   <!-- Optional JavaScript -->
    ...
    Session s=FactProvider.getFactory().openSession();
...
CriteriaQuery<Note> crt = builder.createQuery(Note.class);
 ...
 Root<Note> root = crt.from(Note.class);
   ...
   crt.orderBy(builder.desc(root.get("addDate")));
   ...
   List<Note> list=q.getResultList();
    ...
    <div class="card mt-5">
        ...
        <% SimpleDateFormat fmt=new SimpleDateFormat("E dd-MMM,yyyy");
          ...
          String date=fmt.format(notes.getAddDate());
